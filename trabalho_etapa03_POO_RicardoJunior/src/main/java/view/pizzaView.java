...
try {
    ...
    String query = "INSERT INTO pizza (molho, recheio, borda, nome, preco, dataDeValidade, peso) VALUES (?, ?, ?, ?, ?, ?, ?)";
    PreparedStatement statement = connection.prepareStatement(query);
    statement.setString(1, pizza.getMolho());
    statement.setString(2, pizza.getRecheio());
    statement.setString(3, pizza.getBorda());
    statement.setString(4, pizza.getNome());
    statement.setDouble(5, pizza.getPreco());
    statement.setDate(6, new java.sql.Date(pizza.getDataDeValidade().getTime()));
    statement.setDouble(7, pizza.getPeso());
    
    statement.executeUpdate();
    
    JOptionPane.showMessageDialog(pizzaView.this, "Pizza cadastrado com sucesso!");
    limparCampos();
    ...
    e.printStackTrace();
    JOptionPane.showMessageDialog(pizzaView.this, "Erro ao cadastrar a pizza");
}
